<template>
  <div class="page">
    <div class="card">
      ...
      <header class="topbar">
        <div>
          ...
          <p>
            ...
            "Fwd: Pembayaran Berhasil" &amp;
            "Fwd: Konfirmasi Pemesanan Tiket Pesawat:".
          </p>
        </div>
        <div class="right">
      ...
      <!-- Isi: TicketTable; scroll hanya di dalam komponen ini -->
      <TicketTable />
    </div>
  </div>
</template>
...
/* Card utama yang menampung header + TicketTable */
.card {
  width: 100%;
  max-width: 1280px;
  margin: 0 auto;
  ...
  gap: 6px;
  overflow: hidden; /* penting: isi di dalam yang scroll */
}
